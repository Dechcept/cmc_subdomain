...
const ProductHeading = ({ img, title, description }) => {
  ...
  return (
    <div>
      <div>
        ...
        >
          <div className=" bg-white h-full w-full bg-opacity-10  flex flex-col justify-center items-center gap-5 p-3 pt-24 ">
