  ...
  return (
    <MainLayout>
      <div onScroll={handlescroll}>
        ...
        <div className="overflow-hidden">
          <div
            className=" text-3xl mx-40  border-b-2 border-solid border-[#D9D9D9]-500 pb-5 max-lg:mx-20 max-sm:mx-5 "
            data-aos="fade-up"
            data-aos-duration="2000"
          >
            <h1 className="">Current Openings</h1>
          </div>

          <div
            className="grid grid-cols-4 mx-40 max-lg:mx-20 max-md:flex max-md:flex-col max-sm:mx-5"
            data-aos="fade-up"
            data-aos-duration="2000"
          >
            {jobData.length > 0 ? (
              ...
              <div className="text-[#4D4D4D] p-5 ">
                Cannot find a suitable vacancy? Send your resume
                <p className="text-blue-700">hrcmc@gmail.com</p>
              </div>
            )}
          </div>
        </div>
